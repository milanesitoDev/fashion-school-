...
import TeacherCalendar from './pages/teacher/calendar/Calendar.page';
import TeacherCalification from './pages/teacher/califications/Calification.page';
      ...
      <Route path="/" element={<Layout />}>
        ...
        <Route element={<RequireAuth allowedRoles={[ROLES.Teacher]} />}>
          <Route
            ...
            <Route path="/teacher/calendar" element={<TeacherCalendar teacherData={teacherData} />}
          ></Route>
          <Route path="/teacher/calification" element={<TeacherCalification teacherData={teacherData} />}
          ></Route>
